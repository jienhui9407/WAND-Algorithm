...
if __name__ == '__main__':
    ...
    list.append(['in', 'in'])
    list.append(['to'])
    list.append(['to', '3', 'to', '3'])
    list.append(['web'])
    list.append(['web', 'web'])
    list.append(['100', '100'])
    list.append(['100'])
    list.append(['100', 'web','to', '3'])
    list.append(['s', '100', 's'])
    list.append(['web', 'web'])
    list.append(['web', 'browser', 'web', 'browser', 'web', 'browser', 'web', 'browser'])
    list.append(['100', '100','software', 'patent', 'law', 'faces', 'axe'])
    list.append(
        ['Ink', 'helps', 'drive', 'democracy', 'in', 'Asia', 'The', 'Kyrgyz', 'Republic', 'a', 'small', 'mountainous',
         'state', 'of', 'the', 'former'])
    list.append(
        ['EU', 'software', 'patent', 'law', 'faces', 'axe', 'The', 'European', 'Parliament', 'has', 'thrown', 'out',
         'a', 'bill', 'that', 'would', 'have', 'allowed', 'software', 'to', 'be', 'patented', 'Politicians',
         'unanimously', 'rejected', 'the', 'bill', 'and', 'now', 'it', 'must', 'go', 'through', 'anot'])
    list.append(
        ['Ink', 'helps', 'drive', 'democracy', 'in', 'Asia', 'The', 'Kyrgyz', 'Republic', 'a', 'small', 'mountainous',
         'state', 'of', 'the', 'former', 'EU', 'software', 'patent', 'law', 'faces', 'axe', 'The', 'European',
    ...
    list.append(
        ['EU', 'software', 'patent', 'law', 'faces', 'axe', 'The', 'European', 'Parliament', 'has', 'thrown', 'out',
         'a', 'bill', 'that', 'would', 'have', 'allowed', 'software', 'to', 'be', 'patented', 'Politicians',
         'unanimously', 'rejected', 'the', 'bill', 'and', 'now', 'it', 'must', 'go', 'through', 'anot', 'EU',
         'software', 'patent', 'law', 'faces', 'axe', 'The', 'European', 'Parliament', 'has', 'thrown', 'out',
         'a', 'bill', 'that', 'would', 'have', 'allowed', 'software', 'to', 'be', 'patented', 'Politicians',
         'unanimously', 'rejected', 'the', 'bill', 'and', 'now', 'it', 'must', 'go', 'through', 'anot'])
    for query in list:
        for top_k in range(1, 7):
            print("query = ", query, " top_k =", top_k)
            topk_result, full_evaluation_count = wand_algorithm.WAND_Algo(query, top_k, inverted_index)
